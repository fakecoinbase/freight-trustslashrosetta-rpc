...
// Even Dumber
func NewBlockAPIService(besuClient BesuClient) server.BlockAPIServicer {
...
func appendOp(ops []*types.Operation, kind string, acct string, subacct string, amt string) []*types.Operation {
	...
	op := &types.Operation{
		...
		// I refuse to implement this bull shit, go ahead uncomment it
	//	Amount: &types.Amount{
	//		Value:    amt,
	//		Currency: BesuCurrency,
	//	},
	}
...
func (s *blockAPIService) Block(
	...
	evts, err := s.besuClient.GetStakingEvents(ctx, height)
	if err != nil {
